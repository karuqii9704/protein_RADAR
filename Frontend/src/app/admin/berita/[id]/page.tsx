...
export default function BeritaDetailPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await apiDelete(`/api/admin/berita/${params.id}`);
      if (res.success) {
  ...
  if (!berita) {
    return (
      <div className="text-center py-20">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2">Berita tidak ditemukan</h3>
        <Link href="/admin/berita" className="text-green-600 hover:underline">
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                berita.isPublished ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
              }`}>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                ...
                <span className="font-bold text-gray-900">{berita.viewCount.toLocaleString()}</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{berita.author.name}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-2 bg-gray-100 rounded-lg">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {new Date(berita.updatedAt).toLocaleDateString('id-ID')}
                  </p>
                </div>
              </div>
            </div>
